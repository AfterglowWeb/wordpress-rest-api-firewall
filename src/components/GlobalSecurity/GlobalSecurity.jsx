...
export default function GlobalSecurity( { form, setField } ) {
	...
	return (
		<Stack p={ 4 } flexGrow={ 1 } spacing={ 3 }>
			...
			<Stack direction={{xs:'column', xl:'row'}} gap={ 3 } spacing={ 3 }>
                ...
                <Stack spacing={ 3 }>
                    ...
                    <FormControl>
                        ...
                        <FormHelperText>
                            { __(
                                'Enforce secure HTTP headers for enhanced security.',
                                'rest-api-firewall'
                            ) }
                        </FormHelperText>
                    </FormControl>
                    ...
                    <FormControl>
                        <FormControlLabel
                            ...
                            label={ __(
                                'Enforce Compression HTTP Headers',
                                'rest-api-firewall'
                            ) }
                        />
                        <FormHelperText>
                            { __(
                                'Enforce compression HTTP headers for enhanced performance.',
                                'rest-api-firewall'
                            ) }
                        </FormHelperText>
                    </FormControl>
                    ...
                    <FormControl>
                        <FormControlLabel
                            ...
                            label={ __(
                                'Enforce HTTP Headers site-wide',
                                'rest-api-firewall'
                            ) }
                        />
                        <FormHelperText>
                            { __(
                                'Enforce HTTP headers on the WordPress front pages.',
                                'rest-api-firewall'
                            ) }
                        </FormHelperText>
                    </FormControl>
